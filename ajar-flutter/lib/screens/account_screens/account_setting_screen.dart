...
import 'package:ajar/screens/account_screens/close_account_screens/close_account_explanation_screen.dart';
import 'package:ajar/screens/account_screens/notification_setting_screen.dart';
import 'package:ajar/screens/account_screens/update_password_screen.dart';
import 'package:ajar/utils/theme_colors_constants.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AccountSeetingScreen extends StatefulWidget {
  const AccountSeetingScreen({super.key});

  @override
  State<AccountSeetingScreen> createState() => _AccountScreenState();
}

class _AccountScreenState extends State<AccountSeetingScreen> {
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            const CloseAccountExplanationScreen(),
                      ),
                    );
                  },
                ),
