                ...
                child: CustomGradientButton(
                  ...
                  onPressed: () async {
                    ...
                    if (authProvider.user!.profileCompletion != '100.00') {
                      showCustomSnackBar(
                        context,
                        "Complete your profile to 100% if you want to become host!",
                        Colors.yellow,
                      );
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const ProfileDetailsScreen(), // Replace with your actual update profile screen widget
                        ),
                      );
                    } else {
                      if (authProvider.user!.role!.title == "Host") {
                        ...
                        //   context,
                        //   MaterialPageRoute(
                        //     builder: (context) => const CustomStepperForm(),
                        //   ),
                        // );
                      } else {
