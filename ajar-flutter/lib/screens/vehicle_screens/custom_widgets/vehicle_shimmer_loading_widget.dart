    ...
    return Padding(
      ...
      child: Stack(
        children: [
          ...
          //   child: Shimmer.fromColors(
          //     baseColor:
          //         isDarkMode ? fdarkBlue.withOpacity(0.6) : Colors.grey[300]!,
          //     highlightColor:
          //         isDarkMode ? fMainColor.withOpacity(0.35) : Colors.grey[100]!,
          //     child: Container(
          //       width: 20,
          //       height: 20,
          //       color: isDarkMode
          //           ? darkBaseColor
          //           : Colors.grey[300], // Placeholder for favorite icon
          //     ),
          //   ),
          // ),
        ],
